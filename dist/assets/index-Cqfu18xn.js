...
`;class M{constructor(e,n,a,i,r,o){this.id=e,this.nombre=n,this.img=a,this.descr=i,this.fecha=r,this.enlace=o}}const re=[new M(0,"3 Days of Type","Tab.gif","Tres letras diseñadas en base a una representación visual del sonido diferente.","Enero 2024","tipografia"),new M(1,"Terra","Terra.png","Campaña para alentar a chicas de bachillerato a que estudien la carrera de Geomática y Topografía en la UPV","Junio 2023","advertising"),new M(2,"LPLS","Lpls.png",'Cartel y folleto para el festival "La Palabra y los Sentidos".',"Febrero 2024","festival"),new M(3,"Ocoa","Chocolate.gif","Rebranding de marca para una empresa de chocolate Valenciana que se rejuvenece de su tradición.","Marzo 2023","branding")],g=(t,e)=>{t.innerHTML=`  
  ...
  <main>  
    ...
    <img class="w-screen h-auto" src="./proyectos/Tabletas.png" alt="">
    ...
    <img class="w-screen h-auto pb-10" src="./proyectos/Pegatina.png" alt="">
    ...
    <img class="w-screen h-auto pb-10" src="./proyectos/Bolsa.png" alt="">
    <img class="w-screen h-auto pb-10" src="./proyectos/Tarjeta.png" alt="">
    <img class="w-screen h-auto pb-10" src="./proyectos/Rotulo.png" alt="">
    <img class="w-screen h-auto pb-10" src="./proyectos/Camisetas.png" alt="">
    <video class="w-screen h-auto pb-10" autoplay muted loop src="./proyectos/Stories.mp4"></video>
...
<body> 
    ...
    <main>  
      ...
      <div class="espacio"></div>
        <img class="w-screen max-w-[45rem] h-auto vertical" src="./proyectos/Lepesepe.jpg" alt="">
      ...
      <img class="w-screen h-auto" src="./proyectos/Flyer.gif" alt="">
      ...
      <img class="w-screen max-w-[45rem] vertical h-auto pb-[12rem]" src="./proyectos/Lpls.png" alt="">
      <img class="w-screen max-w-[50rem] h-auto pb-[7rem] pr-4 vertical" src="./proyectos/Folleto1.png" alt="">
      <img class="w-screen max-w-[50rem] h-auto pb-[4rem] pr-4 vertical" src="./proyectos/Folleto2.png" alt="">
...
<body> 
    ...
    <main>  
      ...
      <div class="espacio"></div>
        <img class="w-screen max-w-[45rem] h-auto vertical" src="./proyectos/PosterMockup.jpg" alt="">
      ...
      <img class="w-screen h-auto" src="./proyectos/BannerMockup.jpg" alt="">
      ...
      <img class="w-screen max-w-[45rem] vertical h-auto pb-[12rem]" src="./proyectos/Terra.png" alt="">
      <img class="w-screen max-w-[80rem] h-auto pb-[12rem] vertical" src="./proyectos/Banderola.jpg" alt="">
      <img class="w-screen h-auto" src="./proyectos/OrdenadorMockup.jpg" alt="">
      <div class="bg-[#d0d0d0]">
        <video class="w-screen max-w-[80rem] h-auto vertical" autoplay muted loop src="./proyectos/Posts.mov"></video>
      </div>
      <div class="bg-[#d0d0d0]">
        <video class="w-screen max-w-[100rem] h-auto vertical subir" autoplay muted loop src="./proyectos/Historias.mp4"></video>
      </div>
      <div class="bg-[#d0d0d0]">
        <video class="w-screen max-w-[80rem] h-auto vertical subir" autoplay muted loop src="./proyectos/Filters.mov"></video>
      </div>
      ...
      <img class="w-screen max-w-[50rem] vertical h-auto subir" src="./proyectos/Niña.gif" alt="">
    </main>
...
<body> 
    ...
    <main>  
      ...
      <div class="espacio"></div>
        <img class="w-screen max-w-[60rem] h-auto vertical" src="./proyectos/Tab.gif" alt="">
      ...
      <img class="w-screen max-w-[40rem] h-auto vertical pb-[7rem]" src="./proyectos/T.jpg" alt="">
      <img class="w-screen max-w-[40rem] h-auto vertical pb-[7rem]" src="./proyectos/A.jpg" alt="">
      <img class="w-screen max-w-[40rem] h-auto vertical pb-[7rem]" src="./proyectos/B.jpg" alt="">
      
      <video class="w-screen h-auto pb-[7rem]" autoplay muted loop src="./proyectos/Osciloscopio.mp4"></video>
      <video class="w-screen max-w-[70rem] h-auto vertical pb-[7rem]" autoplay muted loop src="./proyectos/Cimatica.mp4"></video>
      <video class="w-screen h-auto" autoplay muted loop src="./proyectos/Espectrograma.mp4"></video>
